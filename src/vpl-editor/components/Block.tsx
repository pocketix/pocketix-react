...
const Block = (props: {
    ...
    return (
        <>
            <div className="block">
                {block.map((statement, index) => {
                    ...
                    return <Statement onUp={() => {move(index, -1)}}
                                      ...
                                      backgroundColor={props.language.err.backgroundColor} openButton={false}
                                      isOpen={false}
            ...
            <Dialog onHide={() => {setDialogVisible(false)}} visible={dialogVisible} header={<span>Add statement</span>}  footer={
                <>
