...
const Expression = (props: {language: Language, expressionValue?: string, onExpressionValueChanged?: CallableFunction}) => {
	...
	const footer = <>
		<Button label="Cancel" icon="pi pi-times" disabled={syntaxError} onClick={() => setVisible(false)} className="p-button-text" />
	...
	return (
		<>
			<div className="p-inputgroup">
				<InputText className="input-field"  value={expressionString} onChange={(e) => updateExpression(e.target.value)} onClick={preventDefaults}/>
